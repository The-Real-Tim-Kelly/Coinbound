...
function drawBackground() {
  ...
  bg.addColorStop(0.0, '#1C0A44');
  bg.addColorStop(0.45, '#0C0420');
  bg.addColorStop(1.0, '#03010B');
  ctx.fillStyle = bg;
...
function drawCoin() {
  ...
  fg.addColorStop(0.0, '#FFF162');
  fg.addColorStop(0.1, '#FFD700');
  fg.addColorStop(0.42, '#FFAF00');
  fg.addColorStop(0.73, '#E07600');
  fg.addColorStop(1.0, '#7A3C00');
  arc(CX, CY, faceR);
  ctx.fillStyle = fg;
  ctx.fill();

  ctx.beginPath();
  ctx.arc(CX, CY, R - 8, Math.PI * 1.1, Math.PI * 1.9);
  ...
  ctx.beginPath();
  ctx.arc(CX, CY, R - 8, Math.PI * 0.1, Math.PI * 0.9);
  ...
  shine.addColorStop(0.0, 'rgba(255, 255, 255, 0.52)');
...
console.log(
  `    Size: ${(buffer.length / 1024).toFixed(1)} KB  |  1024 × 1024 px`,
);
